...
import com.codepotro.osboard.compat.InputConnectionCompatUtils;
import com.codepotro.osboard.keyboard.common.Constants;
import com.codepotro.osboard.keyboard.common.UnicodeSurrogate;
import com.codepotro.osboard.keyboard.common.StringUtils;
import com.codepotro.osboard.keyboard.inputlogic.PrivateCommandPerformer;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.codepotro.osboard.keyboard.common.Constants.UnicodeSurrogate
